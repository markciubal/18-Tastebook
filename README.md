...
* As a user, I want to be able to view all the students and get a total of the number of students enrolled in a course.

* As a user, I want to be able to view a specific student's overall grade  (average) in the class using MongoDB operators and their score on each assignment.
